...
const PERMISSIONS: Record<BackendRole, GovernedAction[]> = {
  ...
  author: ["Author", "EstablishBaseline", "Intervene", "IngestEvidence", "SubmitPilotDataset", "ProposePilotPolicy"],
  operator: [
    "Author", "EstablishBaseline", "Intervene", "IngestEvidence", "PromoteCandidate",
    "SubmitPilotDataset", "ProposePilotPolicy",
  ],
  ...
  steward: ["Flag", "Halt", "Exclude", "AuditRead", "ActivatePilotPolicy", "RetirePilotPolicy"],
};
